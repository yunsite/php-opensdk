...
if(isset($_GET['exit']))
{
    OpenSDK_163_Weibo::setParam(OpenSDK_163_Weibo::OAUTH_TOKEN, null);
    OpenSDK_163_Weibo::setParam(OpenSDK_163_Weibo::ACCESS_TOKEN, null);
    OpenSDK_163_Weibo::setParam(OpenSDK_163_Weibo::OAUTH_TOKEN_SECRET, null);
	echo '<a href="?go_oauth">点击去授权</a>';
}
else if(
        OpenSDK_163_Weibo::getParam (OpenSDK_163_Weibo::ACCESS_TOKEN) &&
        OpenSDK_163_Weibo::getParam (OpenSDK_163_Weibo::OAUTH_TOKEN_SECRET)
        )
{
	//已经取得授权
	$uinfo = OpenSDK_163_Weibo::call('users/show');
	echo '你已经获得授权。你的授权信息:<br />';
	echo 'Access token: ' , OpenSDK_163_Weibo::getParam (OpenSDK_163_Weibo::ACCESS_TOKEN) , '<br />';
	echo 'oauth_token_secret: ' , OpenSDK_163_Weibo::getParam (OpenSDK_163_Weibo::OAUTH_TOKEN_SECRET) , '<br />';
...
{
	echo '网易微博OAuth1.0接口演示<a href="?go_oauth">点击去授权</a>';
}
